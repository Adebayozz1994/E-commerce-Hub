...
const products = [
  {
    ...
    description: 'Moisturizers, serums, and cleansers for glowing skin.',
    price: 3000,
  ...
  },
  {
    id: 2,
    name: 'Bracelets',
    description: 'Bangles or charm bracelets to add a classy touch to your wrist..',
    price: 2000,
  ...
  },
  {
    id: 3,
    name: 'Watches',
    description: 'Trendy wristwatches for fashion and functionality.',
    price: 7000,
  ...
  {
    id: 4,
    name: 'Perfumes and Body Sprays',
    description: 'Long-lasting scents to boost confidence.',
    price: 5000,
  ...
  },
  {
    id: 5,
    name: 'Essential Oils',
    description: 'Aromatic oils for relaxation and skincare.',
    price: 3000,
  ...
  },
  {
    id: 6,
    name: 'Body Mists',
    description: 'Light, fragrant mists for everyday freshness.',
    price: 2500,
  ...
  },
  {
    id: 8,
    name: 'Anklets',
    description: 'Beautiful anklets to wear with casual or beach outfits.',
    price: 1500,
  ...
  },
  {
    ...
    description: 'Vibrant shades to enhance lips for any occasion.',
    price: 1500,
  ...
  },
  {
    id: 10,
    name: 'Makeup Kits',
    description: 'Complete sets including foundation, eyeshadow, and blush.',
    price: 10000,
  ...
  {
    id: 12,
    name: 'Handbags and Clutches',
    description: 'Designer bags and compact clutches for carrying essentials.',
    price: 80000,
  ...
  },
  {
    id: 13,
    name: 'Toe Rings',
    description: 'Delicate and fashionable rings for toes.',
    price: 1000,
