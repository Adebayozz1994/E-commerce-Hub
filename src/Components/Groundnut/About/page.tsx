      ...
      <div className="min-h-screen bg-yellow-200 flex flex-col items-center p-6">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-3xl">
          ...
          <p className="text-red-800 mb-6">
            Here at The NUTural Bites , we believe in the purity of our product.
            No additives or preservatives – just pure, natural groundnuts which
            are roasted to perfection, delivering unbeatable flavor in every
            bite.
          </p>
          ...
          <p className="text-red-800 mb-6">
            Our roasting process ensures that every nut is treated with care,
            resulting in a snack that s not only delicious but also crunchy,
          ...
          <p className="text-red-800 mb-6">
            At The NUTural Bites, we re dedicated to creating a healthier, more
            sustainable snacking experience that s perfect for anyone looking
            for a natural, wholesome treat.
          </p>
        </div>

        <div className="mt-6 flex flex-col md:flex-row gap-4 mb-20">
          <Image
            src="https://res.cloudinary.com/dzaz4b8pw/image/upload/v1738142803/IMG-20250128-WA0017_efjpm3.jpg"
