    ...
    <div>
      <div className="min-h-screen bg-yellow-200 flex flex-col items-center p-6">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-lg">
          <div className="mb-4">
            ...
            <p className="text-red-800">
              📞{" "}
              <a href="https://wa.me/08064514572" className="underline">
                08064514572
              </a>
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="text-red-800">
              🏠 Stadium Area, Behind Stadium Baptist Church, Ogbomosho, Oyo
              State
            </p>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 mb-11">
          ...
          />
          <Image
            src="https://res.cloudinary.com/dzaz4b8pw/image/upload/w_1000,ar_1:1,c_fill,g_auto,e_art:hokusai/v1738142803/IMG-20250128-WA0017_efjpm3.jpg"
            alt="groundnut image"
            width={350}
            height={250}
            className="rounded-lg shadow-md"
